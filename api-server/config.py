...
HLS_PART_HOLD_BACK_PARTS = float(os.environ.get("HLS_PART_HOLD_BACK_PARTS", "6"))
HLS_MEDIA_CACHE_TTL = float(os.environ.get("HLS_MEDIA_CACHE_TTL", "30"))
HLS_MEDIA_CACHE_MAX_BYTES = int(os.environ.get("HLS_MEDIA_CACHE_MAX_BYTES", str(64 * 1024 * 1024)))
